    ...
    <div class="col">
        <div class="row">
            <div class="col-sm-12 col-lg-9">
                <div style="background-color: rgba(255, 255, 255, .85)" class="rounded-lg shadow p-4">
                <div class="row">
                    <h4><b>My name is Ian James and its time for you to hire me to help develop your software.</b></h4>
                    <br>
                    <p>
